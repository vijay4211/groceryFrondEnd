...
const Cart = () => {
  ...
  // product change then useEffect call or cartItems change then useEffect will call
  useEffect(() => {
  ...
  // ager product ki lenth > 0 hai matalab products hai and cartItems yaha true hai tabhi yaha pura code chale
  return (
    <div>
      <h2 className="bg-green-600 text-white">Cart Page</h2>
                ...
                <div className="flex items-center md:gap-6 gap-3">
                  ...
                  >
                    <img
                      ...
                      //0th index wali image show hongi
                      src={product.image[0]}
                      alt={product.name}
                    />
                  </div>
          ...
          <div className="max-w-[360px] w-full bg-gray-100/40 p-5 max-md:mt-16 border border-gray-300/70">
            ...
            <div className="text-gray-500 mt-4 space-y-2">
              ...
              <p className="flex justify-between text-lg font-medium mt-3">
                ...
                {/* calculate amount with include tax */}
                <span>
